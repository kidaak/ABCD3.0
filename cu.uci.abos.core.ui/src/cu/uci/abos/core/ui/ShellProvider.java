...
public class ShellProvider {
	public static final String APPLICATION_SHELL = ShellProvider.class
	...
	public ShellProvider(IPlatformContributor[] uiProviders,
			ILayoutProvider layoutProvider, LayoutContextImpl ctx) {
