...
public class ContentProvider implements IPlatformContributor {
	public static final String CONTENT_CONTROL = ContentProvider.class
			.getName() + "#CONTENT";

	private final IServiceProvider serviceProvider;

	public ContentProvider(IServiceProvider serviceProvider) {
