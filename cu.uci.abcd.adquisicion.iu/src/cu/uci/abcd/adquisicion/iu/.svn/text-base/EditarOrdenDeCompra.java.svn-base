...
public class EditarOrdenDeCompra implements IContributor {
...
FormLayout layout = new FormLayout();
		...
		gp1.setText("Modificar Orden de Compra");
		...
		bt1.setText(AbosMessages.get().BUTTON_UPDATE);
		...
		bt3.setText(AbosMessages.get().BUTTON_UPDATE);
		
		Button bt4 = new Button(composite2, SWT.PUSH);
		bt4.setText(AbosMessages.get().BUTTON_CLOSE);
		
		FormDatas.attach(bt3).atTopTo(tab3, 25).atLeftTo(composite2, 770);
