package cu.uci.abos.l10n.management.nomenclator;
...
public class AbosMessages {
	...
	public String LABEL_USED;
	public String LABEL_TYPE_OF_RECORD;
	public String LABEL_TYPE_OF_USER;
	public String LABEL_TYPE_OF_WORKER;
	public String LABEL_NAME_LASTNAME;
	public String LABEL_USER;
	public String LABEL_DATE;
	public String LABEL_DATA_LAST_UPDATING;
	...
	public static AbosMessages get() {
		return RWT.NLS.getISO8859_1Encoded(
				AbosMessageConstants.ABOS_MESSAGES_MANAGEMENT_NOMENCLATOR_CLASS_NAME,
				AbosMessages.class);
	}
}
