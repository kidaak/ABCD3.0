...
public class NewSubscription2 implements IContributor {

	@Override
	public String contributorName() {
		// TODO Auto-generated method stub
		return MessageUtil.unescape(AbosMessages.get().CONTRIBUTOR_NEW_SUBSCRIPTION2);
	}

	@Override
	public String getID() {
		// TODO Auto-generated method stub
		return "BusquedaServidoresID";
	}
	...
	parent.setData(RWT.CUSTOM_VARIANT, "gray_background");
        ...
        Table table = new Table(grpDetallesDeLa, SWT.BORDER);
		
		table.setHeaderVisible(true);
		table.setLinesVisible(true);
	     
		TableItem tableItem1 = new TableItem(table, SWT.None);
		tableItem1.setText(AbosMessages.get().TABLE_BEGINS_WITH);
	    ...
	    tableColum2.setWidth(60);
	    tableColum2.setText(MessageUtil.unescape(AbosMessages.get().TABLE_NUMBER));
	    
	    TableItem tableItem2 = new TableItem(table, SWT.BORDER);
	    tableItem2.setText(AbosMessages.get().TABLE_EXPECTED_COPIES);
	    
	    TableEditor tableEditor = new TableEditor(table);
	    tableEditor.grabHorizontal = true;
	    
	    Text text2 = new Text(table, 0);
	    Text text3 = new Text(table, 0);
	    
	    text2.setText("1");
	    text3.setText("0");
	    
	    tableEditor.setEditor(text2, tableItem1, 1);
	    
	    tableEditor = new TableEditor(table);
	    tableEditor.grabHorizontal = true;
	    
	    tableEditor.setEditor(text3, tableItem2, 1);
		
		FormDatas.attach(table).atTopTo(grpDetallesDeLa, 5).atLeftTo(publication, 120);
