...
public class CompoundLabel extends Composite {
	...
	public CompoundLabel(Composite parent, int style, ControlType controlType) {
	...
	public void setPosition(int style, int margin) {
		switch (style) {
		case SWT.TOP:

			FormDatas.attach(control).atTopTo(label, margin).withWidth(170)
					.atLeft(5);
		...
		case SWT.LEFT:
			...
			FormDatas.attach(control).atLeftTo(label, margin).withWidth(170);
