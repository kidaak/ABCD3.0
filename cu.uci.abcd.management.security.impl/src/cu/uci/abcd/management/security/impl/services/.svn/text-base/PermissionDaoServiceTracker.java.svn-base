...
public class PermissionDaoServiceTracker extends
		ServiceTracker<PermissionDAO, PermissionDAO> {

	IPermissionDaoServiceListener listener;

	public PermissionDaoServiceTracker() {
		super(FrameworkUtil.getBundle(PermissionDaoServiceTracker.class)
				.getBundleContext(), PermissionDAO.class, null);
	}
