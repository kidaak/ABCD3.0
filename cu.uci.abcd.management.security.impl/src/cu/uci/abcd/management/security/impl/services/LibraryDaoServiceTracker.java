...
public class LibraryDaoServiceTracker extends
		ServiceTracker<LibraryDAO, LibraryDAO> {

	private IServiceListener<LibraryDAO> listener;

	public LibraryDaoServiceTracker() {
		super(FrameworkUtil.getBundle(LibraryDaoServiceTracker.class)
				.getBundleContext(), LibraryDAO.class, null);
	}
