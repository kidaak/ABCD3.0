...
public class FormDatas {
	...
	public FormDatas atLeft(int numerator, int offset) {
	...
	public FormDatas atRightNoDenominator(int margin) {
		formData.right = new FormAttachment(margin);
		return this;
	}
