...
public class FDTAddArea implements IEditableArea {
	...
	public Composite createButtons(Composite parent, final IGridViewEntity entity, final IVisualEntityManager manager) {
		...
		saveBtn.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				manager.add(fdtEntity);	//salva visual.
	...
	public void l10n() {		
		...
		typeLbl.setText(AbosMessages.get().HEADER_TYPE_FDT);
		indicatorsLbl.setText(AbosMessages.get().HEADER_INDICATORS_FDT);
		repLbl.setText(AbosMessages.get().HEADER_REP_FDT);
		firstSubfieldLbl.setText(AbosMessages.get().HEADER_FIRST_SUBFIELD_FDT);
