...
public class ASVisualizationContributor implements IContributor {
    ...
    public Control createUIControl(final Composite parent) {
		...
		cba.addRow(new CSearchEntity(001, "Autor personal", "CN_", "Si"));
		cba.addRow(new CSearchEntity(999, "Autor personal", "CN_", "No"));
		cba.addRow(new CSearchEntity(952, "Autor personal", "CN_", "Si"));	

		// Composite de los botones actualizar, exportar a excel, exportar a pdf y cancelar
		...
		updateBtn.addSelectionListener(new SelectionListener() {
		    ...
		    public void widgetSelected(SelectionEvent event) {
		    	//event.getSource().createEditionArea(event.data, event.item, true);
		    }
