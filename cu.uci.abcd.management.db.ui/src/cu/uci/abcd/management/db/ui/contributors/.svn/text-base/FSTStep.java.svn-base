...
/*
	...
	CRUDTreeTable fdt = new CRUDTreeTable(middleGroup, FDTViewEntity.class, true, true, true);

	fdt.addRow(new FDTViewEntity(0, "nombre", 1, true, false, true, "ab"));
	fdt.addRow(new FDTViewEntity(1, "apellidos", 1, false, true, false, "ab"));
	...
	CRUDTreeTable fst = new CRUDTreeTable(middle2Group, FSTViewEntity.class, true, true, true);
