 ...
 */
public class ClientResourceLoaderUtil {

  private static final String CHARSET = "UTF-8";
  private static final ClassLoader CLASSLOADER = ClientResourceLoaderUtil.class.getClassLoader();

  private ClientResourceLoaderUtil() {
