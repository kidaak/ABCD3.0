...
public class ClientCustomBehaviors {
  ...
  private static final String RESOURCES_PREFIX = "cu/uci/abos/validation/ui/";
...
//ok
  public static void toOnlyDigitsForce( Text text ) {
    String scriptCode
      = ClientResourceLoaderUtil.readTextContent( RESOURCES_PREFIX + "DigitsOnlyForce.js" );
    ClientListener clientListener = new ClientListener( scriptCode );
    text.addListener( SWT.Verify, clientListener );
  }
...
//ok
  public static void toOnlyLettersForce( Text text ) {
    String scriptCode
      = ClientResourceLoaderUtil.readTextContent( RESOURCES_PREFIX + "LettersOnlyForce.js" );
    ClientListener clientListener = new ClientListener( scriptCode );
    text.addListener( SWT.Verify, clientListener );
  }
