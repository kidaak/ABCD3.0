...
public class ValidationUtil {
	/**
	 * Recive un arreglo de checksboxes y calcula la cantidad de checkboxes que hay seleccionados.
	...
	/**
	 * Recive dos DateTime y retorna 1 si to es mayor que from, -1 si to es menos que from y 0 
	 ...
	 * @param dateTime - fecha en formato dateTime.
	 */
	private static GregorianCalendar ConvertoDataTimeToGregorianCalendar(
			DateTime dateTime) {
