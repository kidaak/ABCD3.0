...
public class OpacHeaderProvider implements IPlatformContributor {
	public static final String HEADER_CONTROL = OpacHeaderProvider.class
			.getName() + "#HEADER";
	...
	public void Login(String user) {
		...
		Menu dropDownMenuProfile = createDropDownMenuText1(dropDownProfileItem,
				User);
	...
	public void logout() {
		...
		OpacAdquisitionMenu adquisitionMenu = service
				.get(OpacAdquisitionMenu.class);
		adquisitionMenu.composite.setVisible(false);

		OpacCirculationMenu circulationMenu = service
	...
	private Composite createProfileMenu(Composite parent,
		...
		FormDatas.attach(login).withWidth(140).atTop(20).atLeft(20)
				.atBottom(20);
