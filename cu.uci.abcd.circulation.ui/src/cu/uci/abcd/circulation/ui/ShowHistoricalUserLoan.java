...
public class ShowHistoricalUserLoan implements IContributor{

	@Override
	public String contributorName() {
		return "Mostrar Historial de Usuario de Prestamo";
	}
	@Override
	public String getID() {
		return ShowHistoricalObjectLoan.class.getSimpleName() + "id21";
	}
	...
	public Control createUIControl(Composite parent) {
		...
		//grupo.setText("HISTORIAL DE UN USUARIO DE PRESTAMO");
		...
		FormDatas.attach(separador1).atTopTo(tabla, 20).withWidth(900);
		
		//----------------------------------------
		TabFolder tabFolder = new TabFolder(grupo, SWT.NONE);
		
		FormDatas.attach(tabFolder).atTopTo(separador1, 15).withWidth(900).withHeight(200);
		
		//Group g1 = new Group(tabFolder, SWT.NONE);
		...
		lab3.setText(MessageUtil.unescape(AbosMessages.get().LABEL_USER_HISTORICAL_LOAN_TRANSACTIONS));
		FormDatas.attach(lab3).atTopTo(g1,10).atLeftTo(g1, 10);
		...
		lab4.setText(MessageUtil.unescape(AbosMessages.get().LABEL_USER_HISTORICAL_LOAN_RESERVATIONS));
		...
		columna41.setWidth(100);
		columna41.setText("No. de Control");
		
		TableColumn columna411 = new TableColumn(tabla4, SWT.NONE);
		columna411.setWidth(100);
		columna411.setText("Tipo de Objeto");
		
		
		TableColumn columna121 = new TableColumn(tabla4, SWT.NONE);
		columna121.setWidth(150);
		columna121.setText("Fecha de Reservacion");

		TableColumn columna231 = new TableColumn(tabla4, SWT.NONE);
		columna231.setWidth(150);
		columna231.setText("Fecha de Vencimiento");
		
		TableColumn columna412 = new TableColumn(tabla4, SWT.NONE);
		columna412.setWidth(80);
		columna412.setText("Ejecutada");
				
		TableColumn columna61 = new TableColumn(tabla4, SWT.NONE);
		columna61.setWidth(80);
		...
		lab5.setText(MessageUtil.unescape(AbosMessages.get().LABEL_USER_HISTORICAL_LOAN_SANCTIONS));
